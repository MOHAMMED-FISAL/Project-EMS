                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" value="<?php echo $employee['name']; ?>" placeholder="Enter full Name" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="email" class="form-control" name="email" value="<?php echo $employee['email']; ?>"  placeholder="Enter email">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
...
<?php 
        if(isset($_POST['u_update'])) {
            ...
            $femail = $_POST['email'];
            $pass = $_POST['pass'] ;
            $sql = "UPDATE register SET username ='$username',name=' $fname',email=' $femail' WHERE id='$id'";
